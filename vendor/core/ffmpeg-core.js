...
["_main","_malloc","_free","_memory","___indirect_function_table","_fflush","_ff_h264_cabac_tables","___start_em_asm","___stop_em_asm","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
var ASM_CONSTS = {
  4885064: ($0) => { if (Module["logger"]) { Module["logger"]({ type: "stderr", message: UTF8ToString($0) }); } },  
 4885159: ($0) => { if (Module["receiveProgress"]) Module["receiveProgress"]($0, $0); }
};
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 4546780;
